...
function Main(props) {
    ...
    let circle1 = 150 + R30/2
    let circle2 = 150 + R30/2
                                    ...
                                    <fieldset id="fieldset-svg">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" onClick={(e) => {
                                            ...
                                            <polygon id="triangle" stroke="black" fill="transparent" fill-opacity="0.3"
                                                     points={`${150 - R30 / 2},150 150,${150 + R30 / 2} 150,150`}/>

                                            <polygon id="rectangle" stroke="black" fill="transparent" fill-opacity="0.3"
                                                     points={`150,150 150,${150 - R30} ${150 + R30/2},${150 - R30} ${150 + R30/2},150`}/>

                                            <path id="circle"
                                                  d={`M150,${circle1} A${R30/2},${R30/2} 180 0,0 ${circle2},150 L 150,150 Z`}
